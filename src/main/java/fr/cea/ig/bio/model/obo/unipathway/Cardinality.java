...
public class Cardinality {
    ...
    public String toString( ) {
        ...
        if( is_primary != null ) {
            final String s =  Boolean.toString( is_primary );
            final String capitalized = Character.toUpperCase(s.charAt(0)) + s.substring(1);
            result.append( ",is_primary=\"" + capitalized + "\"" );
        }
        if( is_alternate != null ) {
            final String s = Boolean.toString( is_alternate );
            final String capitalized = Character.toUpperCase( s.charAt( 0 ) ) + s.substring( 1 );
            result.append( ",is_alternate=\""+capitalized+"\"" );
        }
        result.append( "}" );
