...
//        terms.add( new ArrayList<>( Arrays.asList( new TermRelations( "1a", "1a", "1a" ), new TermRelations( "1b", "1b", "1b" ) ) ) );
//        terms.add( new ArrayList<>( Arrays.asList( new TermRelations( "2a", "2a", "2a" ) ) ) );
